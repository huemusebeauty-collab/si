        ...
        <aside className="rounded-xl border border-line bg-surface p-5">
          ...
          <div className="mx-auto max-w-sm overflow-hidden rounded-lg border border-line bg-white shadow-rest">
            ...
            <div className="p-5 text-sm">
              <div className="grid grid-cols-2 gap-4 border-b border-line pb-4"><div><div className="text-xs text-muted">Bill To</div><strong>Customer Name</strong><div className="text-xs text-muted">Customer address</div></div><div><div className="text-xs text-muted">Invoice reference</div><strong>Generated from order</strong><div className="text-xs text-muted">Final legal invoice number is assigned by the invoicing workflow.</div></div></div>
