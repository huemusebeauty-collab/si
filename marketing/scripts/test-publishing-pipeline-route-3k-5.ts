...
const content = await lifecycle.createContent({ contentId: "route-test", format: "post", hook: "h", body: "b", callToAction: "c", status: "scheduled", requiresApproval: true } as never);
