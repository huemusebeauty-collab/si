...
// Stop browser/proxy caches from restoring the old workspace shell.
...
console.log('SILKU HQ workspace routes rebuilt cleanly with real dashboard shell');
