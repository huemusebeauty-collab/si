...
const end = source.indexOf('`;\n\nexport function dashboardHtml', start);
if (end < 0) throw new Error('HQ dashboard JS template end not found');
...
source = source.slice(0,start) + marker + cleanJs + source.slice(end+1);
fs.writeFileSync(file, source);
console.log('Final clean HQ dashboard browser script installed');
